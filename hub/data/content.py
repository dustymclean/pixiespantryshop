        ...
        "sections": [
            ...
            },
            {
                ...
                "items": [
                    ...
                    ("XVAPE", "XVAPE", "Vaporizer manufacturer focused on the medical cannabis market, with hybrid convection devices at mid-range prices.", "Good middle rung on the ladder &mdash; more control than a $60 pen without Storz &amp; Bickel money.", None),
        ...
        "sections": [
            ...
            },
            {
                ...
                "items": [
                    ...
                    ("Sider", "Sider", "Browser-based AI assistant for reading, summarising and comparing pages.", "Useful for chewing through spec sheets and manufacturer PDFs before a review.", None),
                    ("Shopify", "Shopify", "Hosted ecommerce platform &mdash; storefront, checkout, payments and shipping.", "If I were starting a store today without a WordPress background, this is what I'd tell you to use. Nothing to maintain.", None),
                    ...
                    ("Learnworlds Ltd", "LearnWorlds", "Course platform for building and selling online courses from your own site.", "The right tool if your knowledge is the product. Better student experience than dumping videos in a members area.", None),
            ...
            },
            {
                ...
                "items": [
                    ...
                    ("DocuSign", "DocuSign", "Legally binding electronic signatures and agreement workflows.", "Vendor agreements, wholesale terms and event contracts &mdash; signed same day, stored, searchable.", None),
                    ...
                    ("MyDataRemoval", "MyDataRemoval", "Service that removes your personal information from data-broker sites.", "If you put your face on the internet in this industry, do this. Learned that one the hard way.", None),
            ...
            },
            {
                ...
                "items": [
                    ...
                    ("Razer Affiliate Program", "Razer", "Gaming peripherals, laptops and audio.", "Their peripherals are genuinely good for long editing sessions, not just gaming theatre.", None),
                    ...
                    ("TORRAS", "TORRAS", "Phone cases, chargers and cooling accessories.", "Their magnetic cooling cases genuinely stop a phone throttling mid-shoot.", None),
                ],
            },
        ],
    },
        ...
        "sections": [
            {
                ...
                "items": [
                    ...
                    ("ESIM USA", "eSIM USA", "eSIM data plans aimed at visitors to the United States.", "The one to send friends flying in, not the one you buy flying out.", None),
            ...
            },
            {
                ...
                "items": [
                    ...
                    ("Alaska Airlines Mileage Plan - Points.com", "Alaska Mileage Plan", "Official Alaska Mileage Plan miles portal.", "Alaska's partner award chart is the best-kept secret in US loyalty.", None),
            ...
            },
            {
                ...
                "items": [
                    ...
                    ("Morrocco Method", "Morrocco Method", "Raw, vegan, chemical-free hair and scalp care.", "Genuinely minimal ingredient lists in a category built on chemistry you can't pronounce.", None),
            ...
            },
            {
                ...
                "items": [
                    ("Larson Jewelers (US)", "Larson Jewelers", "Alternative-metal wedding bands &mdash; tungsten, titanium, damascus and inlays.", "Where you buy a ring you can actually work in. A fraction of jewellery-store pricing for better durability.", None),
                    ...
                    ("Andyanand US", "Andy Anand", "Handmade chocolates, cakes and sugar-free confections.", "Sugar-free options that are actually good &mdash; useful when you're gifting to someone managing intake.", None),
            ...
            },
            {
                ...
                "items": [
                    ...
                    ("ROLLINGDOG US", "Rolling Dog", "Dog mobility gear including wheelchairs, harnesses and supports.", "Mobility gear for older and disabled dogs. If you need this, you really need it.", None),
                ],
            },
        ],
    },
